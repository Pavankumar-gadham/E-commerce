...
class checkout(View):
    def get(self, request):
        ...
        #{'amount': 24000, 'amount_due': 24000, 'amount_paid': 0, 'attempts': 0, 'created_at': 1733217478, 'currency': 'INR', 'entity': 'order', 'id': 'order_PSeQt7KXHkjHb0', 'notes': [], 'offer_id': None, 'receipt': 'order_rcptid_12', 'status': 'created'}
...
def payment_done(request):
    ...
    if isinstance(request.user, AnonymousUser):
        messages.error(request, "Please log in to complete your order.")
